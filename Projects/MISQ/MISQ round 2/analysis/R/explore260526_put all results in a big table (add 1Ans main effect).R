...
##############################################
######## 260526 Setup 1 + AISimWithAccept_fillna
##############################################
models <- list()
...
wordreg(models,
          stars = c(0.1, 0.05, 0.01, 0.001),
          file = "Projects/MISQ/MISQ round 2/analysis/outputs/explore260526_SimWithAccept-Setup1.docx", inline.css = FALSE, doctype = FALSE, html.tag = TRUE, head.tag = TRUE, body.tag = TRUE,
          digits = 3, dcolumn = TRUE, threeparttable = TRUE, fontsize = "tiny",
...
##############################################
######## 260526 Setup 2 + AISimWithAccept_fillna
##############################################
models <- list()
...
wordreg(models,
          stars = c(0.1, 0.05, 0.01, 0.001),
          file = "Projects/MISQ/MISQ round 2/analysis/outputs/explore260526_SimWithAccept-Setup2.docx", inline.css = FALSE, doctype = FALSE, html.tag = TRUE, head.tag = TRUE, body.tag = TRUE,
          digits = 3, dcolumn = TRUE, threeparttable = TRUE, fontsize = "tiny",
          include.fstatistic = TRUE, include.adjrs = FALSE, include.rsquared = FALSE,
          include.groups = FALSE, single.row = FALSE,
          omit.coef = omit_pattern
...
wordreg(models,
          stars = c(0.1, 0.05, 0.01, 0.001),
          file = "Projects/MISQ/MISQ round 2/analysis/outputs/explore260526_SimWithOpus47-Setup1.docx", inline.css = FALSE, doctype = FALSE, html.tag = TRUE, head.tag = TRUE, body.tag = TRUE,
          digits = 3, dcolumn = TRUE, threeparttable = TRUE, fontsize = "tiny",
          include.fstatistic = TRUE, include.adjrs = FALSE, include.rsquared = FALSE,
          include.groups = FALSE, single.row = FALSE,
          omit.coef = omit_pattern
...
wordreg(models,
          stars = c(0.1, 0.05, 0.01, 0.001),
          file = "Projects/MISQ/MISQ round 2/analysis/outputs/explore260526_SimWithOpus47-Setup2.docx", inline.css = FALSE, doctype = FALSE, html.tag = TRUE, head.tag = TRUE, body.tag = TRUE,
          digits = 3, dcolumn = TRUE, threeparttable = TRUE, fontsize = "tiny",
          include.fstatistic = TRUE, include.adjrs = FALSE, include.rsquared = FALSE,
          include.groups = FALSE, single.row = FALSE,
          omit.coef = omit_pattern
...
##############################################
######## 260526 Setup 1 + AISimWithDeepseek_fillna
##############################################
models <- list()
models[["DV: # human answers"]] <- felm(log_answer_que_within7day ~ treatment
      + log_textLengthCN_ask + IimgNum_ask + IaNum_ask + IblockquoteNum_ask + ItableNum_ask + lingComp_score + techJargon_score + difficulty_score
...
wordreg(models,
          stars = c(0.1, 0.05, 0.01, 0.001),
          file = "Projects/MISQ/MISQ round 2/analysis/outputs/explore260526_SimWithDeepseek-Setup1.docx", inline.css = FALSE, doctype = FALSE, html.tag = TRUE, head.tag = TRUE, body.tag = TRUE,
          digits = 3, dcolumn = TRUE, threeparttable = TRUE, fontsize = "tiny",
          include.fstatistic = TRUE, include.adjrs = FALSE, include.rsquared = FALSE,
          include.groups = FALSE, single.row = FALSE,
          omit.coef = omit_pattern
...
##############################################
######## 260526 Setup 2 + AISimWithDeepseek_fillna
##############################################
models <- list()
models[["DV: # other answers"]] <- felm(log_answer_que_within7day_other ~ treatment
      + log_textLengthCN_ask + IimgNum_ask + IaNum_ask + IblockquoteNum_ask + ItableNum_ask + lingComp_score + techJargon_score + difficulty_score
...
wordreg(models,
          stars = c(0.1, 0.05, 0.01, 0.001),
          file = "Projects/MISQ/MISQ round 2/analysis/outputs/explore260526_SimWithDeepseek-Setup2.docx", inline.css = FALSE, doctype = FALSE, html.tag = TRUE, head.tag = TRUE, body.tag = TRUE,
          digits = 3, dcolumn = TRUE, threeparttable = TRUE, fontsize = "tiny",
          include.fstatistic = TRUE, include.adjrs = FALSE, include.rsquared = FALSE,
          include.groups = FALSE, single.row = FALSE,
          omit.coef = omit_pattern
...
##############################################
######## 260526 Setup 1 + AISimWithAccept_fillna (Accepted Anchor handled)
##############################################
models <- list()
models[["DV: # human answers"]] <- felm(log_answer_que_within7day ~ treatment
      + log_textLengthCN_ask + IimgNum_ask + IaNum_ask + IblockquoteNum_ask + ItableNum_ask + lingComp_score + techJargon_score + difficulty_score
...
wordreg(models,
          stars = c(0.1, 0.05, 0.01, 0.001),
          file = "Projects/MISQ/MISQ round 2/analysis/outputs/explore260526_handleanchor_SimWithAccept-Setup1.docx", inline.css = FALSE, doctype = FALSE, html.tag = TRUE, head.tag = TRUE, body.tag = TRUE,
          digits = 3, dcolumn = TRUE, threeparttable = TRUE, fontsize = "tiny",
          include.fstatistic = TRUE, include.adjrs = FALSE, include.rsquared = FALSE,
          include.groups = FALSE, single.row = FALSE,
          omit.coef = omit_pattern
...
##############################################
######## 260526 Setup 2 + AISimWithAccept_fillna (Accepted Anchor handled)
##############################################
models <- list()
models[["DV: # other answers"]] <- felm(log_answer_que_within7day_other ~ treatment
      + log_textLengthCN_ask + IimgNum_ask + IaNum_ask + IblockquoteNum_ask + ItableNum_ask + lingComp_score + techJargon_score + difficulty_score
...
wordreg(models,
          stars = c(0.1, 0.05, 0.01, 0.001),
          file = "Projects/MISQ/MISQ round 2/analysis/outputs/explore260526_handleanchor_SimWithAccept-Setup2.docx", inline.css = FALSE, doctype = FALSE, html.tag = TRUE, head.tag = TRUE, body.tag = TRUE,
          digits = 3, dcolumn = TRUE, threeparttable = TRUE, fontsize = "tiny",
          include.fstatistic = TRUE, include.adjrs = FALSE, include.rsquared = FALSE,
          include.groups = FALSE, single.row = FALSE,
          omit.coef = omit_pattern
